...
<head>
    ...
    <title>Login Admin - Biper Baby Care</title>
...
<body class="font-sans bg-gray-50 antialiased h-screen overflow-hidden">
    ...
    <div class="h-screen flex" x-data="{ showPassword: false }">
            ...
            <div class="w-full max-w-[420px]">
                ...
                <div class="mb-7">
                    <div class="flex items-center gap-2 mb-4">
                        <span class="inline-flex items-center gap-1.5 bg-biper-pink/10 text-biper-pink text-xs font-semibold px-3 py-1 rounded-full">
                            <i class="fas fa-shield-halved text-[10px]"></i>
                            Admin Panel
                        </span>
                    </div>
                    <h2 class="font-display text-2xl font-bold text-gray-800">Selamat Datang</h2>
                    <p class="text-gray-400 text-sm mt-1">Masuk dengan akun admin untuk melanjutkan</p>
                </div>
                ...
                <form action="{{ route('admin.login.submit') }}" method="POST" class="space-y-4">
                    ...
                    {{-- Email --}}
                    <div>
                        <label for="email" class="block text-sm font-medium text-gray-600 mb-1.5">Email <span class="text-biper-pink">*</span></label>
                        <div class="relative">
                            ...
                            <input type="email" name="email" id="email"
                                   value="{{ old('email') }}"
                                   class="w-full pl-10 pr-4 py-3 bg-gray-50 border border-gray-200 rounded-xl text-sm text-gray-800 placeholder-gray-300 focus:outline-none focus:border-biper-pink focus:ring-2 focus:ring-biper-pink/10 transition"
                                   placeholder="nama@biper.com" autofocus>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center">
                        <label class="flex items-center gap-2 cursor-pointer">
                            <input type="checkbox" name="remember"
                                   class="w-4 h-4 rounded border-gray-300 text-biper-pink focus:ring-biper-pink/30">
                ...
                <div class="mt-6 text-center">
                    <a href="{{ route('pageHome') }}" class="text-sm text-gray-400 hover:text-biper-pink transition inline-flex items-center gap-1.5">
